...
\path{dataset_manifest.csv}, and their aggregate statistics. The exact source
revision recorded with the experiment is
\texttt{4ce898f}; the complete revision identifier is retained in the
experiment metadata.
...
\url{https://github.com/ravikanthreddy89/chaotic-image-encryption}.
