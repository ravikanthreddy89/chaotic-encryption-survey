...
Each complete scheme implements a common \texttt{IImageCipher} interface.
...
\end{verbatim}
Primary result files include \texttt{results/final/bench.csv},
\texttt{stage\_bench.csv}, \texttt{candidate\_schemes.csv},
\texttt{analysis.csv}, \texttt{dataset\_manifest.csv}, and their aggregate
statistics. The exact source revision recorded with the experiment is
\texttt{4ce898f284f6367921637f8f7d43aa2d2910517e}.
