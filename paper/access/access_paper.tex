...
\path{results/jrtip_realtime_arm}; they contain CSV, Markdown, and summary-text
measurements, not generated ciphertext images or downloaded datasets.
...
\bibitem{chai2015} X. Wu, Y. Li, and J. Kurths, ``A new color image encryption
