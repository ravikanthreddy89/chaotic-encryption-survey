...
|---|---|---|---|---:|
| CA-Feistel-ARX | cellular_automata | feistel_index | arx_block | 100.64 |
| Checkerboard-CA-ARX | cellular_automata | checkerboard_swaps | arx_block | 461.89 |
...
| Affine-CML-Bitplane | cml | affine_bitplane | bitplane | 62.39 |
